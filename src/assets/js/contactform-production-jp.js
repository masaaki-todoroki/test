...
$(document).ready(function () {
	...
	var option = {
		pages: [
			{
				'path': ['/jp/contact/production/'],
				'button': {
					'areaClassName': 'submit-button', // <p class="submit-button">[submit "送信する"]</p>
					'confirm': '<div id="to-confirm" class="p-form__button-wrap"><div class="p-form__button-text--arrow-wrap"><div class="p-form__button-text--arrowright"><input class="button-confirm p-form__button p-form__button-text" type="button" value="確認画面へ" /></div></div></div>', // html
					'rewrite': '<div id="to-rewrite" class="p-form__button-wrap"><div class="p-form__button-text--arrow-wrap"><div class="p-form__button-text--arrowleft"><input class="button-rewrite p-form__button p-form__button-text" type="button" value="入力内容を修正する" /></div></div></div>' // html
				}
			}
		],
		validates: {
